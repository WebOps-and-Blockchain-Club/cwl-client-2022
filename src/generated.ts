...
export type GetIssuesQuery = { __typename?: 'Query', getIssues: Array<{ __typename?: 'Issue', location: string, phoneNumber: string, tags: string, username: string }> };
...
export type LoginQuery = { __typename?: 'Query', login: { __typename?: 'LoginResponse', success: boolean, username: string, tags: string } };
...
export type PostIssueMutation = { __typename?: 'Mutation', postIssue: { __typename?: 'Issue', desc: string, phoneNumber: string, tags: string, location: string } };
