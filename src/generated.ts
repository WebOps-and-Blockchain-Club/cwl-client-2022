...
export type GetWaterDataMutation = { __typename?: 'Mutation', getWaterData: Array<{ __typename?: 'WaterData', id: string, date: any, depth: number, flagged?: boolean | null, image: string, location: string, remarks?: string | null }> };
