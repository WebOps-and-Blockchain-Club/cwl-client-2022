...
export type GetWaterDataQuery = { __typename?: 'Query', getWaterData: Array<{ __typename?: 'WaterData', date: any, location: string, depth: number }> };
...
export type SignUpMutation = { __typename?: 'Mutation', signIn: { __typename?: 'Volunteer', id: string, tags: string, phoneNumber: string, username: string } };
...
export type PostIssueMutation = { __typename?: 'Mutation', complaintInput: { __typename?: 'Issue', desc: string, phoneNumber: string, tags: string, location: string } };
...
export type UpdateIssueMutation = { __typename?: 'Mutation', updateInput: { __typename?: 'Issue', status: string } };
...
export const TestQueryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"testQuery"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"testQuery"}}]}}]} as unknown as DocumentNode<TestQueryQuery, TestQueryQueryVariables>;
...
export const GetIssuesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"getIssues"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"issues"}}]}}]} as unknown as DocumentNode<GetIssuesQuery, GetIssuesQueryVariables>;
